        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center  lg:justify-start animate__animated animate__fadeInUp animate__delay-2s">
              ...
              <Link to={"https://drive.google.com/file/d/1rJVoUFjZLPtvjAFyxCb_Ry4s3SrEAeiT/view?usp=sharing"}><button className="px-8 py-4 max-w-40 bg-white/10 text-white rounded-full font-medium hover:bg-white/20 transition-all backdrop-blur-sm">
                Watch Demo
              </button></Link>
